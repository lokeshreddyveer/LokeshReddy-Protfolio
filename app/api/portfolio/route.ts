...
export async function POST(request: Request) {
  ...
  const live = await callGemini(prompt) || await callCompatible("https://api.groq.com/openai/v1/chat/completions", value("GROQ_API_KEY"), "llama-3.3-70b-versatile", prompt) || await callCompatible("https://openrouter.ai/api/v1/chat/completions", value("OPENROUTER_API_KEY"), value("OPENROUTER_MODEL") || "openrouter/free", prompt, { "HTTP-Referer": "https://lokeshreddy.dev", "X-Title": "Lokesh Reddy Portfolio" });
